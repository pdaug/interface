import{j as n}from"./jsx-runtime-D_zvdyIk.js";import{D as O}from"./CaretDown-iWlDRJZr.js";import{S as s,I as _,w as D,G as x,a as W,P as N}from"./Sidebar-DjRrwX27.js";import{r as d}from"./index-DQLiH3RP.js";import"./IconBase-DM5o4K-0.js";import"./Profile-BsT31ePo.js";import"./Avatar-KQlzqCkx.js";import"./Dropdown-B2VCto3_.js";const H={title:"components/Sidebar",component:s,tags:["autodocs"]},o=()=>{const[a,e]=d.useState("dashboard");return n.jsx(s,{path:a,menu:[{id:"dashboard",label:"Dashboard",onClick:()=>e("dashboard")},{id:"orders",label:"Orders",onClick:()=>e("orders")},{id:"inflow",label:"Inflow",onClick:()=>e("inflow")},{id:"outflow",label:"Outflow",onClick:()=>e("outflow")},{id:"statements",label:"Statements",onClick:()=>e("statements")}]})},t=()=>{const[a,e]=d.useState("dashboard");return n.jsx(s,{path:a,menu:[{id:"financial",name:"Financial",Icon:_,items:[{id:"dashboard",label:"Dashboard",onClick:()=>e("dashboard")},{id:"orders",label:"Orders",onClick:()=>e("orders")}]},{id:"administrative",name:"Administrative",Icon:D,items:[{id:"customers",label:"Customers",onClick:()=>e("customers")},{id:"suppliers",label:"Suppliers",onClick:()=>e("suppliers")}]}]})},l=()=>{const[a,e]=d.useState("dashboard");return n.jsx(s,{path:a,header:{padding:!1,name:"Company Name",description:"Workspace Selected",dropdown:{children:n.jsx("div",{className:"cursor",children:n.jsx(O,{})}),values:[{id:"workspace_1",label:"Workspace 1"},{id:"workspace_2",label:"Workspace 2"}]}},menu:[{id:"dashboard",label:"Dashboard",onClick:()=>e("dashboard")},{id:"orders",label:"Orders",onClick:()=>e("orders")},{id:"inflow",label:"Inflow",onClick:()=>e("inflow")},{id:"outflow",label:"Outflow",onClick:()=>e("outflow")},{id:"statements",label:"Statements",onClick:()=>e("statements")}]})},i=()=>{const[a,e]=d.useState("dashboard");return n.jsx(s,{path:a,menu:[{id:"dashboard",label:"Dashboard",onClick:()=>e("dashboard")},{id:"orders",label:"Orders",onClick:()=>e("orders")},{id:"inflow",label:"Inflow",onClick:()=>e("inflow")},{id:"outflow",label:"Outflow",onClick:()=>e("outflow")},{id:"statements",label:"Statements",onClick:()=>e("statements")}],footer:{padding:!1,name:"",description:"John Doe",photoCircle:!0,dropdown:{children:n.jsx("div",{className:"cursor",children:n.jsx(x,{})}),values:[{id:"settings",label:"Settings"},{id:"sign_out",label:"Sign Out"}]}}})},r=()=>{const[a,e]=d.useState("dashboard");return n.jsx(s,{path:a,header:{padding:!1,name:"Company Name",description:"Workspace Selected",dropdown:{children:n.jsx("div",{className:"cursor",children:n.jsx(O,{})}),values:[{id:"workspace_1",label:"Workspace 1"},{id:"workspace_2",label:"Workspace 2"}]}},menu:[{id:"financial",name:"Financial",Icon:_,items:[{id:"dashboard",label:"Dashboard",onClick:()=>e("dashboard")},{id:"orders",label:"Orders",onClick:()=>e("orders")},{id:"inflow",label:"Inflow",onClick:()=>e("inflow")},{id:"outflow",label:"Outflow",onClick:()=>e("outflow")},{id:"statements",label:"Statements",onClick:()=>e("statements")}]},{id:"administrative",name:"Administrative",Icon:D,items:[{id:"customers",label:"Customers",onClick:()=>e("customers")},{id:"suppliers",label:"Suppliers",onClick:()=>e("suppliers")},{id:"employees",label:"Employees",onClick:()=>e("employees")}]},{id:"operational",name:"Operational",Icon:W,items:[{id:"products",label:"Products",onClick:()=>e("products")},{id:"services",label:"Services",onClick:()=>e("services")},{id:"vehicles",label:"Vehicles",onClick:()=>e("vehicles")}]},{id:"tools",name:"Tools",Icon:N,items:[{id:"documents",label:"Documents",onClick:()=>e("documents")},{id:"schedules",label:"Schedules",onClick:()=>e("schedules")}]}],footer:{padding:!1,name:"",description:"John Doe",photoCircle:!0,dropdown:{children:n.jsx("div",{className:"cursor",children:n.jsx(x,{})}),values:[{id:"settings",label:"Settings"},{id:"sign_out",label:"Sign Out"}]}}})};o.__docgenInfo={description:"",methods:[],displayName:"Default"};t.__docgenInfo={description:"",methods:[],displayName:"Group"};l.__docgenInfo={description:"",methods:[],displayName:"WithHeader"};i.__docgenInfo={description:"",methods:[],displayName:"WithFooter"};r.__docgenInfo={description:"",methods:[],displayName:"All"};var c,m,p;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`() => {
