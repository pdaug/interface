...
import { Asterisk, CarProfile } from "@phosphor-icons/react";
            ...
            <Vertical internal={1} className="flex1">
              ...
              <Horizontal internal={1}>
                ...
                <InputMoney
                  ...
                  id="vehicle_total"
                  value={form?.total || ""}
                  label={`${t.components.total} (${Convert.stringToCurrency(instance.currency)})`}
                  onChange={function (value) {
                    const newForm = { ...form };
                    newForm.total = value || "";
              ...
              <Horizontal internal={1}>
                <InputSelect
                  ...
                  onChange={function (event) {
                    ...
                    newForm.unitType = newUnitType as TypeVehicleRefuelUnitType;
                    setForm(newForm);
                    return;
                  }}
                />
          ...
          <Table
            ...
            columns={{
              ...
              gas_station: {
                label: t.vehicle.gas_station,
                handler: function (data) {
                  if (data.gasStation) return data.gasStation as string;
                  return (
