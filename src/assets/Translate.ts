const TranslatePt = {
  ...
  callout: {
    company_document_search:
      "Ao preencher a entrada 'Documento (CNPJ)', será pesquisado e preenchido automaticamente os dados da empresa",
    person_mobile_search:
      "Ao preencher a entrada 'Número de Celular', será preenchido automaticamente com os dados do WhatsApp",
    postal_code_search:
      "Ao preencher a entrada 'Código Postal (CEP)', será buscado automaticamente o endereço através da base da dados pública",
    required_fields: "As entradas com asteriscos são obrigatórios",
    shipping_value:
  ...
  inflow: {
    ...
    entity_id: "Seleção da entidade",
    payment_date: "Data de pagamento",
    payment_method: "Método de pagamento",
    payment_value: "Valor",
    payment_expires: "Data de vencimento",
    payment_times: "Parcela atual",
    payment_installments: "Total de parcelas",
    no_installments: "Nenhuma parcela encontrada",
    // placeholders
    name_placeholder: "Ex. Recebimento adiantado",
    description_placeholder:
      "Ex. Digite aqui uma breve descrição sobre a receita",
    // stages
    draft: "Rascunho",
    pending: "Pendente",
    ...
    purchases: "Compras",
    orders: "Ordens",
    vehicle_maitenances: "Manutenções de veículos",
    vehicle_refuels: "Abastecimentos de veículos",
    manual: "Manual",
    // payment method
    credit_card: "Cartão de crédito",
    debit_card: "Cartão de débito",
    bank_transfer: "Transferência bancária",
    e_wallet: "Carteira digital",
    benefit_card: "Vale Alimentação/Refeição",
    ...
    pix: "Pix",
    boleto: "Boleto",
    transfer_ted: "Transferência TED",
    transfer_doc: "Transferência DOC",
    // titles and subtitles
    title_edit: "Edite a receita",
    title_create: "Crie uma nova receita",
    subtitle: "Preencha as entradas para criar ou editar a receita",
    title_installments: "Parcelas",
    title_advanced: "Avançado",
    subtitle_advanced:
      "Preencha as entradas com dados avançados sobre a receita",
  },
  integration: {
    integration: "Integração",
  ...
  plans: {
    ...
    plan_essential_description:
      "Recomendado para empreendedores que estão começando.",
    plan_advanced: "Avançado",
    plan_advanced_description:
      "Recomendado para empresas que buscam ampliar o controle do financeiro e de seus processos.",
    plan_professional: "Profissional",
    plan_professional_description:
      "Recomendado para organizações que priorizam a eficiência e automações de processos através de uma solução completa.",
    item_suport: "Suporte",
    item_app_mobile: "Aplicativo no celular",
    item_only_1_user: "Apenas 1 usuário",
    item_only_1_workspace: "Apenas 1 organização",
    item_financial_module: "Apenas módulo financeiro",
...
const TranslateEn = {
  ...
  inflow: {
    ...
    payment_times: "Current installment",
    payment_installments: "Total installments",
    no_installments: "No installments found",
    // placeholders
    name_placeholder: "e.g. Advance receipt",
    description_placeholder:
      "e.g. Type here a brief description about the inflow",
    // stages
    draft: "Draft",
    pending: "Pending",
    ...
    purchases: "Purchases",
    orders: "Orders",
    vehicle_maitenances: "Vehicle maintenances",
    vehicle_refuels: "Vehicle refuels",
    manual: "Manual",
    // payment method
    ...
    pix: "Pix",
    boleto: "Boleto",
    transfer_ted: "Bank transfer TED",
    transfer_doc: "Bank transfer DOC",
    // titles and subtitles
    title_edit: "Edit the inflow",
    title_create: "Create a new inflow",
    subtitle: "Fill the inputs to create or edit the inflow",
    title_installments: "Installments",
    title_advanced: "Advanced",
    subtitle_advanced: "Fill the inputs with advanced data about the inflow",
  },
  integration: {
    integration: "Integration",
  ...
  plans: {
    ...
    plan_essential_description:
      "Recommended for professionals in initial phase.",
    plan_advanced: "Advanced",
    plan_advanced_description:
      "Recommended for companies that want to have more control over their processes.",
    plan_professional: "Professional",
    plan_professional_description:
      "Recommended for organizations that prioritize efficiency and process automation, being the most complete solution to boost results.",
    item_suport: "Support",
    ...
    item_automations: "Automations unlimited",
