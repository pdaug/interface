const TranslatePt = {
  ...
  customer: {
    ...
    description_placeholder:
      "Preencha aqui uma breve descrição sobre o cliente...",
    document: "Documento",
    ...
    document_2: "Documento (CPF, RG, OAB, CRM...)",
    ...
    subtitle_representative: "Preencha os campos com os dados do representante",
...
const TranslateEn = {
  ...
  customer: {
    ...
    subtitle_representative:
      "Fill the inputs with representative data from customer",
